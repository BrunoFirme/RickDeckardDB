...
public class TableReplicationDirectionDAO extends MasterDAO {
    ...
    private String is_selectOrigem = "select database_origem, tipo_banco, usuario_origem, senha_origem  from tb_replicacao_direcao where codigo_direcao = ?";
    
    private String is_selectDestino = "select database_destino, tipo_banco, usuario_origem, senha_origem from tb_replicacao_direcao where codigo_direcao = ?";
	...
	public ConectionReplication selectOrigem(int codigo) throws SQLException {
		...
		origem.setDatabaseType(rst.getString("tipo_banco"));
	...
	public ConectionReplication selectDestino(int codigo) throws SQLException {
		...
		destino.setDatabaseSID(rst.getString("database_origem"));  
		destino.setDatabaseType(rst.getString("tipo_banco"));
		destino.setUser(rst.getString("usuario_destino"));
		destino.setPassword(rst.getString("usuario_destino"));
